        					  ...
        					  <div class="box">
        						...
        						<!-- /.box-header -->
        						 <%
                                    ...
                                    %>
        						<form class="form" action="../groupes/update" method="post">
        							...
        							<div class="box-body">
                                                                        ...
                                                                        <input type="hidden" name="id" value="<%= groupe.getId() %>">
                                            								<div class="form-group">
                                                                                 ...
                                                                                 <input name="nom" value="<%= groupe.getNom() %>" type="text" class="form-control">
                                                                            </div>


                                            								<div class="form-group">
                                            								  <label class="form-label">Nombre des Etudiants</label>
                                                                            <textarea name="nbre" rows="5" class="form-control"><%= groupe.getNbre() %></textarea>
                                            								</div>
                                            							</div>
        							<!-- /.box-body -->
