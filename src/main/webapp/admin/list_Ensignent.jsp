...
<div class="container text-left">
       ...
       <td><%= enseignant.getNom() %></td>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <td>
                                                                                                                                                                                                                    <a href="../user/edit?role=0&id=<%= enseignant.getId() %>">Edit</a>
                                                                                                                                                                                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                                                                                                                                    <a href="../user/delete?role=0&id=<%= enseignant.getId() %>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                                                                                                                                                                                                                <a href="../EG/list?id=<%= enseignant.getId() %>">voir les groupes</a>
