     	...
     	<div class="d-flex align-items-center logo-box justify-content-start">
     		...
     		<a href="index.html" class="logo">
     		  ...
     		  <div class="logo-mini w-30">
     			  <span class="light-logo"><img src="../assets/enseignant/images/logo-letter.png" alt="logo"></span>
     			  <span class="dark-logo"><img src="../assets/enseignant/images/logo-letter-white.png" alt="logo"></span>
     		  </div>
     		  <div class="logo-lg">
     			  <span class="light-logo"><img src="../assets/enseignant/images/logo-dark-text.png" alt="logo"></span>
     			  <span class="dark-logo"><img src="../assets/enseignant/images/logo-light-text.png" alt="logo"></span>
     		  </div>
     		</a>
     	</div>
         <!-- Header Navbar -->
     			...
     			<li class="dropdown user user-menu">
     				<a href="#" class="waves-effect waves-light dropdown-toggle w-auto l-h-12 bg-transparent p-0 no-shadow" title="User" data-bs-toggle="modal" data-bs-target="#quick_user_toggle">
     					<div class="d-flex pt-1 align-items-center">
     						...
     						<img src="../assets/enseignant/images/avatar/avatar-13.png" class="avatar rounded-circle bg-primary-light h-40 w-40" alt="" />
     					</div>
     				</a>
     			</li>
