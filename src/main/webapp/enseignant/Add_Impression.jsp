...
<script>
    function updateGroupNbr() {
        var select = document.getElementById("selectGroupe");
        var groupNbrInput = document.getElementById("groupNbr");
        var selectedOption = select.options[select.selectedIndex];
        var groupNbr = selectedOption.getAttribute("data-nbre");

        groupNbrInput.value = groupNbr;
    }
</script>
        	  ...
        	  <div class="container-full">
        		...
        		<section class="content">
        		 <div class="box">
        					  ...
        					  <div class="box">
        						<div class="box-header with-border">
        						  <h4 class="box-title">demande impression</h4>
        						</div>
        						<!-- /.box-header -->
        						<form action="../UploadServlet" method="post" class="form" enctype="multipart/form-data">
        							<div class="box-body">
        								...
        								<div class="row">
        								  <div class="col-md-6">
        									<div class="form-group">
        									  <label class="form-label">Select le groups</label>
                                             	  ...
                                             	  <select name="nomGroupe" id="selectGroupe" class="form-select" onchange="updateGroupNbr()">
        									<%
                                                List<Groupe> listGroupe = (List<Groupe>) getServletContext().getAttribute("listGroupe");
                                                if (listGroupe != null) {
                                               for (Groupe groupe : listGroupe) {
                                                  %>
                                                   <option  value="<%= groupe.getNom() %>"  data-nbre="<%= groupe.getNbre() %>"><%= groupe.getNom() %></option>
                                                            <%
                                                                    }
                                                                }
                                                            %>
        								  ...
        								  <div class="col-md-6">
        									<div class="form-group">
        									  ...
        									  <select name="nomMatiere" class="form-select">
                                                      									<%
        								...
        								<div class="form-group">
                                            ...
                                            <input name="nbreEtudiant" id="groupNbr" type="text"  class="form-control">
                                        </div>
        								<div class="form-group">
   		  ...
   		  <div class="modal-body p-30 bg-white">
               ...
               <div>
                   <div class="d-flex flex-row">
                       <div class=""><img src="../assets/enseignant/images/avatar/avatar-13.png" alt="user" class="rounded bg-danger-light w-150" width="100"></div>
                       <div class="ps-20">
             ...
             <div class="media-list media-list-hover mt-20">
   			...
   			<div class="media py-10 px-0">
   			  <a class="avatar avatar-lg status-primary" href="#">
   				<img src="../assets/enseignant/images/avatar/4.jpg" alt="...">
   			  </a>
   			  <div class="media-body">
   				<p class="fs-16">
   				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
   			...
   			<div class="media py-10 px-0">
   			  <a class="avatar avatar-lg status-success" href="#">
   				<img src="../assets/enseignant/images/avatar/1.jpg" alt="...">
   			  </a>
   			  <div class="media-body">
   				<p class="fs-16">
   				  <a class="hover-primary" href="#"><strong>Tyler</strong></a>
   			...
   			<div class="media py-10 px-0">
   			  <a class="avatar avatar-lg status-danger" href="#">
   				<img src="../assets/enseignant/images/avatar/2.jpg" alt="...">
   			  </a>
   			  <div class="media-body">
   				<p class="fs-16">
   				  <a class="hover-primary" href="#"><strong>Luke</strong></a>
   			...
   			<div class="media py-10 px-0">
   			  <a class="avatar avatar-lg status-warning" href="#">
   				<img src="../assets/enseignant/images/avatar/3.jpg" alt="...">
   			  </a>
   			  <div class="media-body">
   				<p class="fs-16">
   				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
                   ...
                   <div class="chat-logs">
                       <div class="chat-msg user">
                           <div class="d-flex align-items-center">
                               <span class="msg-avatar">
                                   <img src="../assets/enseignant/images/avatar/2.jpg" class="avatar avatar-lg" alt="">
                               </span>
                               <div class="mx-10">
                       ...
                       <div class="chat-msg self">
                           <div class="d-flex align-items-center justify-content-end">
                               ...
                               <span class="msg-avatar">
                                   <img src="../assets/enseignant/images/avatar/3.jpg" class="avatar avatar-lg" alt="">
                               </span>
                           </div>
                           <div class="cm-msg-text">
